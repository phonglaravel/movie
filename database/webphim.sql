...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2022 at 06:58 AM
...
INSERT INTO `movies` (`id`, `title`, `trailer`, `slug_movie`, `fullepi`, `time`, `view`, `description`, `tags`, `year`, `status`, `hot`, `new`, `resolution`, `sub`, `image`, `category_id`, `genre_id`, `country_id`, `ngaytao`, `ngaycapnhat`) VALUES
(24, 'SÁCH TRẮNG KẾT HÔN, WELCOME TO WEDDING HELL (2022)', NULL, 'sach-trang-ket-hon-welcome-to-wedding-hell-2022', 16, 60, 4, 'Sách Trắng Kết Hôn, Welcome to Wedding Hell (2022) - Lời cầu hôn được xem là một kết thúc có hậu. Nhưng đối với cặp đôi này, nó trở thành khởi đầu của một trận chiến khó khăn: chuẩn bị đám cưới.', 'Sách Trắng Kết Hôn, Welcome to Wedding Hell (2022)', '2022', 1, 1, 1, 0, 0, 'sach-trang-ket-hon-welcome-to-wedding-hell-2022_Tr.jpg', 16, 12, 12, '2022-07-06 18:00:34', NULL),
